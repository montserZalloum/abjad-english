...
# whatever came back.
PROTECTED += [
    # The PRD this factory was built from. Changing the product is a human act.
    "docs/PRD.md",
    # The whole harness is the judge, not just the mutations: a builder that can edit
    # ci.py, the journey, or the content gate can make any claim true. New coverage
    # goes in tests/ (CLAUDE.md).
    "harness/*", "harness/mutations/*",
    # The content gate lives in scripts/ but it is a judgement file (MISSION Gate 2).
    "scripts/validateContent.mjs",
    # CI and repo config.
    ".github/*",
    # Dependency changes need a human (FACTORY_RULES.md 5).
